...
public class PageVO {
	...
	public PageVO(Criteria cri, int total) {
		...
		// 공식 = (int)Math.ceil( 조회하는페이지 / 페이지네이션 갯수) * 페이지네이션 갯수
		...
		// 3. 실제 끝페이지 번호 계산
		// 총 게시글 수가 53개 -> 실제끝번호 6, 마지막페이지(end) 10
		// 총 게시글 수가 171개 -> 실제끝번호 18, 마지막페이지(end) 20
